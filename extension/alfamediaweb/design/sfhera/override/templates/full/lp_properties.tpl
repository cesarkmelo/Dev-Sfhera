...
{default $view = 0
		 ...
		 $page_limit = 9
         $offset = ''
		 $proposeArray = hash( 0, 'rent', 1, 'sale', 2, 'ganga', 3, 'remate', '4', 'turismo' )
		 $properties_count = 0
		 $properties_list = ''}
...
{if ezhttp_hasvariable( 'offset', 'get' )}
	{set $offset = ezhttp( 'offset', 'get' )
	     $get  = concat($get, '&offset=', $offset)}
{/if}

{include uri='design:consulta_inmuebles.tpl' offset=$offset}
